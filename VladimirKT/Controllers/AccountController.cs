    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
					//code for Employee who CanManageMovies
					//var roleStore = new RoleStore<IdentityRole>(new ApplicationDbContext());
					//var roleManager = new RoleManager<IdentityRole>(roleStore);
					//await roleManager.CreateAsync(new IdentityRole("CanManageMovies"));
					//await UserManager.AddToRoleAsync(user.Id, "CanManageMovies");

					//code for Customer who CanManageCustomer
					var roleStore = new RoleStore<IdentityRole>(new ApplicationDbContext());
					var roleManager = new RoleManager<IdentityRole>(roleStore);
					...
					var customerDB = new ApplicationDbContext();
					Customer customer = new Customer();
					customer.AspNetUsersId = user.Id;
					customer.FirstName = model.FirstName;
					customer.LastName = model.LastName;
					customer.NumburOfMovies = 0;
					customer.Credit = 100;
                    ...
                    return RedirectToAction("MovieIndex", "Movie");
                }
                AddErrors(result);
            }
